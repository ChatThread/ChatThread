import {
  getLeftHandleId,
  getRightHandleId,
} from "@/custom-nodes/utils/get-handle-id";
import { INCOMPLETE_LOOP_ERROR_ALERT } from "@/constants/alerts-constants";
import {
  Connection,
  Edge,
  getOutgoers,
...
} from "../types/utils/reactflow-utils";
...
export function updateFlowPosition(NewPosition: XYPosition, flow: FlowType): FlowType {

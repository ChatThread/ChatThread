// authStore.js
import { CHATMAGIC_ACCESS_TOKEN } from "@/constants/constants";
...
const useAuthStore = create<AuthStoreType>((set, get) => ({
  isAdmin: false,
  isAuthenticated: !!cookies.get(CHATMAGIC_ACCESS_TOKEN),
  accessToken: cookies.get(CHATMAGIC_ACCESS_TOKEN) ?? null,
  userData: null,
  autoLogin: null,

...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the ChatThread documentation for more information on how to write your own component.";
...
export const CONTROL_FORGOT_PASSWORD_STATE = {
  password: "",
  cnfPassword: "",
  username: "",
  code: "",
...
export const API_PAGE_PARAGRAPH =
  "Your secret ChatThread API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const CHATMAGIC_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const CHATMAGIC_CHAT_TITLE = "ChatThread Chat";
...
export const STORE_TITLE = "ChatThread Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your ChatThread API key.";
...
export const DEFAULT_TABLE_ALERT_MSG = ``;
...
export const CHATMAGIC_ACCESS_TOKEN = "access_token_lf";
export const CHATMAGIC_API_TOKEN = "apikey_tkn_lflw";
export const CHATMAGIC_AUTO_LOGIN_OPTION = "auto_login_lf";
export const CHATMAGIC_REFRESH_TOKEN = "refresh_token_lf";

export const CHATMAGIC_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const CHATMAGIC_ACCESS_TOKEN_EXPIRE_SECONDS_ENV = 60 * 60 * 24 * 30; // 30 days

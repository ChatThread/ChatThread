...
const CanvasControls = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    <Panel
      ...
      className="react-flow__controls m-2! flex flex-row! gap-1.5 rounded-md border border-secondary-hover bg-background fill-foreground stroke-foreground p-1.5 text-primary shadow-2xs [&>button]:border-0 [&>button]:bg-background [&>button]:hover:bg-accent"

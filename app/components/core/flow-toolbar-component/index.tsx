...
import PlaygroundButton from "@/components/core/flow-toolbar-component/components/PlaygroundButton";
import {
  ENABLE_API,
  ENABLE_CHATMAGIC_STORE,
  ENABLE_PUBLISH,
...
import ApiModal from "../../../modals/api-modal";
...
import FlowToolbarOptions from "./components/FlowToolbarOptions";
  ...
  return (
    <>
      <Panel className="m-2!" position="top-right">
        <div
          className={cn(
            "hover:shadow-round-btn-shadow flex items-center justify-center gap-7 rounded-md border bg-background px-1.5 shadow-2xs transition-all",
            ENABLE_PUBLISH ? "h-11" : "",
          )}
        >
          {ENABLE_PUBLISH ? (

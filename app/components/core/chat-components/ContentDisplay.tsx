...
import SimplifiedCodeTabComponent from "../code-tabs-component/ChatCodeTabComponent";
...
export default function ContentDisplay({
    ...
    <>
      <div className="flex items-center gap-2 pb-[12px]">
        ...
        {content.header.title && (
          <div className="inline-block w-fit max-w-full text-[14px] font-semibold text-foreground">
            <Markdown
  ...
  switch (content.type) {
    case "text":
      contentData = (
        <div className="ml-1 pr-20 markdown prose max-w-full text-[14px] font-normal dark:prose-invert">
          <Markdown
            remarkPlugins={[remarkGfm]}
            components={{
              p({ node, ...props }) {
    ...
    case "tool_use":
      const formatToolOutput = (output: any) => {
        ...
        if (typeof output === "string") {
          return (
            <div className="markdown prose max-w-full text-[14px] font-normal dark:prose-invert">
              <Markdown
                remarkPlugins={[remarkGfm]}                
                components={{
                  pre({ node, ...props }) {
      ...
      contentData = (
        <div className="flex flex-col gap-2">
          ...
          {content.error && (
            <div className="text-red-500 markdown prose max-w-full text-[14px] font-normal dark:prose-invert">
              <Markdown
                remarkPlugins={[remarkGfm]}
              >
                **Error:**

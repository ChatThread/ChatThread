        ...
        >
          ...
          >
            {items.map((item, index) => (
              <div
                key={index}
                className="relative flex h-8 cursor-pointer select-none items-center gap-2 rounded-sm px-2 text-sm outline-hidden transition-colors hover:bg-primary-hover"
                onClick={() => {
                  item.onClick?.();
                  setIsOpen(false);
                }}

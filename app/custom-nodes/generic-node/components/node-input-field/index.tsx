...
import { NodeInfoType } from "@/components/core/parameter-render-component/types";
import { usePostTemplateValue } from "@/controllers/API/queries/nodes/use-post-template-value";
import {
  CustomParameterComponent,
  CustomParameterLabel,
  getCustomParameterTitle,
} from "@/customization/components/CustomParameter";
import useAuthStore from "@/stores/auth-store";
import { cn } from "@/utils/utils";
import { useEffect, useMemo, useRef } from "react";
import { default as IconComponent } from "../../../../components/common/generic-icon-component";
import ShadTooltip from "../../../../components/common/shad-tooltip-component";
import {
  DEFAULT_TOOLSET_PLACEHOLDER,
  FLEX_VIEW_TYPES,
  ICON_STROKE_WIDTH,
  CHATMAGIC_SUPPORTED_TYPES,
} from "../../../../constants/constants";
import useFlowStore from "../../../../stores/flow-store";
import { useTypesStore } from "../../../../stores/types-store";
import { NodeInputFieldComponentType } from "../../../../types/components";
import { scapedJSONStringfy } from "../../../../utils/reactflow-utils";
import useFetchDataOnMount from "../../../hooks/use-fetch-data-on-mount";
import useHandleOnNewValue from "../../../hooks/use-handle-new-value";
import NodeInputInfo from "../node-input-info";
...
export default function NodeInputField({
  ...
  const displayHandle =
    (!CHATMAGIC_SUPPORTED_TYPES.has(type ?? "") ||

import JsonOutputViewComponent from "@/components/core/json-output-component/json-output-view";
...
import DataOutputComponent from "@/components/core/data-output-component";
...
const SwitchOutputView: React.FC<SwitchOutputViewProps> = ({
  ...
  let results: OutputLogType | LogsLogType =
    (type === "Outputs"
      ...
      : flowPoolNode?.data?.logs?.[outputName]) ?? {} as OutputLogType;

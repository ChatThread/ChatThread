...
if [ -z "$CHATMAGIC_API_KEY" ]; then
  echo "Error: CHATMAGIC_API_KEY environment variable not found. Please set your API key in the environment variables."
fi
`
      : ""
  }curl --request POST \\
  ...
  --header 'Content-Type: application/json' \\${
    isAuthenticated
      ? `
  --header "x-api-key: $CHATMAGIC_API_KEY" \\`
      : ""
  }

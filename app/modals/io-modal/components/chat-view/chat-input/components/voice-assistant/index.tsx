...
import SettingsVoiceModal from "./components/audio-settings/SettingsVoiceModal";
import { checkProvider } from "./helpers/check-provider";
import { formatTime } from "./helpers/format-time";
import { workletCode } from "./helpers/stream-processor";
...
export function VoiceAssistant({
  ...
  const chatSessions = useChatSessions({ currentFlowId });

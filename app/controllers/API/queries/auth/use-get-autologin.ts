...
export const useGetAutoLogin: useQueryFunctionType<undefined, undefined> = (
  ...
  async function getAutoLoginFn(): Promise<null> {
    try {
      ...
      const user = {
          "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwYWQwZjk3MS1lODVlLTQ3NDYtYmYwMy1jZTcyOWY5NjJlMjEiLCJ0eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzc2MDA4NTg1fQ.80pgghT-Zcg5C_D9VUXDYL116IHqsrdwpjrNcDKkN2E",
          "refresh_token": "",
          "token_type": "bearer"
      };

import { IS_AUTO_LOGIN, CHATMAGIC_ACCESS_TOKEN } from "@/constants/constants";
...
const api: AxiosInstance = axios.create({
  ...
  baseURL: (import.meta.env.VITE_API_BASE_URL as string) || "http://localhost:7860",
});
  ...
  useEffect(() => {
    ...
    const interceptor = api.interceptors.response.use(
      ...
      async (error: AxiosError) => {
        ...
        //   const accessToken = cookies.get(CHATMAGIC_ACCESS_TOKEN);

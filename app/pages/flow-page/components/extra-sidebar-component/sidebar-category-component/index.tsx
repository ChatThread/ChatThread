...
import { nodeColors, nodeIconsLucide, nodeColorsName } from "@/utils/style-utils";
import { removeCountFromString } from "@/utils/utils";
import DisclosureComponent from "../../disclosure-component";
import SidebarDraggableComponent from "../sidebar-draggable-component";
...
export function SidebarCategoryComponent({
  ...
  return (
    <DisclosureComponent
      ...
      button={{
        title: nodeColorsName[name] ?? nodeColorsName.unknown,
